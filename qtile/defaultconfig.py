...
keys = [
    ...
    # Toggle Floating
    Key([mod, "shift"], "t", lazy.window.toggle_floating(), desc="Toggle Floating Mode"),
    ...
    Key([mod], "r", lazy.spawn("dmenu_run -fn 'Ubuntu-16' -nb '#282a2e' -sb '#5f819d'"), desc="launch dmenu"),
    Key([mod], "w", lazy.spawn("google-chrome"), desc="launch google-chrome"),
...
# LAYOUTS
layouts = [
    layout.Tile(margin=15, border_width=0, border_focus="#bc7cf7", border_normal="#4c566a"),
    layout.Floating()
]
