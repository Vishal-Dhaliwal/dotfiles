...
awful.key({modkey}, "r", function() awful.util.spawn("dmenu_run -p 'run: ' -fn 'Sans-9'") end, {description = "run dmenu", group = "launcher"}),
awful.key({modkey}, "w", function() awful.util.spawn("google-chrome") end, {description = "run web-browser", group = "launcher"}),
awful.key({modkey}, "f", function() awful.util.spawn("nemo") end, {description = "run file-manager", group = "launcher"}),
...
awful.util.spawn("/home/vishal/.config/awesome/autostart.sh")
